...
+ (MFSideMenuShadow *)shadowWithView:(UIView *)shadowedView {
    MFSideMenuShadow *shadow = [MFSideMenuShadow shadowWithColor:[UIColor darkGrayColor] radius:10.0f opacity:0.75f];
...
- (void)show {
    ...
    pathRect.size.height = self.shadowedView.frame.size.height - 360;
