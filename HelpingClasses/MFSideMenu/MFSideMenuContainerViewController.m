...
- (void)setDefaultSettings {
    ...
    self.menuWidth = UIScreen.mainScreen.bounds.size.width - 150;
...
- (void) setCenterViewControllerOffset:(CGFloat)xOffset {
    ...
    if(self.menuState == MFSideMenuStateClosed)
    {
        ...
        UIImageView *img=[[UIImageView alloc]initWithFrame:CGRectMake(frame.origin.x, 0, frame.size.width, frame.size.height)];
        img.image=[UIImage imageNamed:@"720x1280"];
